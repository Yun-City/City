...
[task_local]
#京东手机年终奖
15 0 * * * jd_festival.js, tag=京东手机年终奖, img-url=https://raw.githubusercontent.com/yogayyy/Scripts/master/Icon/sh123ylocks/jd_festival2.jpg, enabled=true
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: `http://jd.tu123ringlabs.net/api/v2/jd/festival/read/${randomCount}/`,
      'timeout': 10000
    }, (err, resp, data) => {
      try {
        if (err) {
