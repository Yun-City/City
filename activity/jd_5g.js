...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: `http://jd.tu123ringlabs.net/api/v2/jd/5g/read/${randomCount}/`,
      'timeout': 10000
    }, (err, resp, data) => {
      try {
        if (err) {
...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    let data = await updateShareCodes("https://gitee.com/sh123ylocks/updateTeam/raw/main/jd_818.json")
    if(data){
