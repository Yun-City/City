...
###           ②若填写为其他内容或留空，则自动调整为按天计算轮换数量(即：轮换账号数量÷当月总天数的商值，取下整数)，对全部脚本有效(除非 recombin_ck_envs 另有设定)；
Recombin_CK_ARG2=""
...
###           ⑧各个活动设定值之间采用 & 连接，例如：jd_fruit@1@5&jd_pet@2@6&jd_plantBean@3@7@4&jd_jxlhb@4@80@1&jd_zdjr@4@5@3@4240059acf5c449a1a986fa6107897ce1@https://cjhydz-isv.isvjcloud.com；
recombin_ck_envs="jd_islogin_xh@3@5@3"
