...
功能：完成任务，互助, 开红包
账号1助力作者，其余账号按顺序内部互助
青龙拉取命令：ql raw https://raw.githubusercontent.com/Yun-City/City/main/jd/jd_golden_yearendBonus.py
2021/12/06 22:30
'''
...
class Msg(object):
    def getsendNotify(self):
        url_list = [
            'https://mirror.ghproxy.com/https://raw.githubusercontent.com/Yun-City/City/main/sendNotify.py',
            'https://cdn.jsdelivr.net/gh/Yun-City/City@main/sendNotify.py',
            'https://raw.fastgit.org/Yun-City/City/main/sendNotify.py',
            'https://raw.githubusercontent.com/Yun-City/City/main/sendNotify.py',
        ]
...
def author_helpcode(cookie):
    url_list = [
        'https://raw.fastgit.org/Yun-City/City/main/shareCodes/helpcode.json',
        'https://mirror.ghproxy.com/https://raw.githubusercontent.com/Yun-City/City/main/shareCodes/helpcode.json',
        'https://cdn.jsdelivr.net/gh/Yun-City/City@main/shareCodes/helpcode.json',
        'https://raw.githubusercontent.com/Yun-City/City/main/shareCodes/helpcode.json',
    ]
    for e,url in enumerate(url_list):
        try:
