...
let appIdArr = ['1E1xZy6s','1FFVQyqw','1GVFUx6g'];
let appNameArr = ['PLUS生活特权','1111点心动','joy的年味之旅'];
let appId, appName;
$.shareCode = [];
if ($.isNode()) {
...
!(async () => {
  ...
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://raw.githubusercontent.com/Yun-City/City/main/shareCodes/wish.json')
  }
