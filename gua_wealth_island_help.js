...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://raw.githubusercontent.com/Yun-City/City/master/shareCodes/wealth_island_code.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('https://raw.githubusercontent.com/Yun-City/City/master/shareCodes/wealth_island_code.json');
    res2 = await getAuthorShareCode('https://raw.githubusercontent.com/Yun-City/City/master/shareCodes/wealth_island_code.json');
    if(!res2[0]) res2 = await getAuthorShareCode('https://raw.githubusercontent.com/Yun-City/City/master/shareCodes/wealth_island_code.json');
