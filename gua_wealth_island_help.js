...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://raw.githubusercontent.com/sm123iek2221/updateTeam/master/shareCodes/wealth_island_code_one.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('https://gitee.com/smi123ek2221/updateTeam/raw/master/shareCodes/wealth_island_code_one.json');
    res2 = await getAuthorShareCode('https://raw.githubusercontent.com/smie123k2221/updateTeam/master/shareCodes/wealth_island_code.json');
    if(!res2[0]) res2 = await getAuthorShareCode('https://gitee.com/smi11123ek2221/updateTeam/raw/master/shareCodes/wealth_island_code.json');
