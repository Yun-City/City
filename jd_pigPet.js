...
!(async () => {
  ...
  if (process.env.PIGPETSHARECODE) {
    ...
    let res = await getAuthorShareCode('https://raw.githubusercontent.com/Yun-City/City/main/shareCodes/pig.json')
    if (!res) {
      res = await getAuthorShareCode('https://raw.githubusercontent.com/Yun-City/City/main/shareCodes/pig.json')
    }
    if (res){
  ...
  console.log(`\n======开始大转盘助力======\n`);
  $.helpId = await getAuthorShareCode('https://raw.githubusercontent.com/Yun-City/City/main/shareCodes/pig.json');
