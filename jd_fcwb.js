...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubuser234content.com/11111110/share_code/main/fcwb.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://cdn.jsdel234ivr.net/gh/11111110/share_code@main/fcwb.json');}catch (e) {}
        if(!res){res = [];}
    }
    if(res.length > 0){
